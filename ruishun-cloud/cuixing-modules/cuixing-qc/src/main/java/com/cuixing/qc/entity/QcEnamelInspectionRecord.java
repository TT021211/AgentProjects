...
/**
 * 质量模块-漆包巡检记录(QcEnamelInspectionRecord)实体类
 *
 * @author makejava
 * @since 2024-07-02 16:56:21
 */
public class QcEnamelInspectionRecord implements Serializable {
    private static final long serialVersionUID = -41014658893129601L;
    /**
     * 漆包巡检记录id
     */
    private Long id;
