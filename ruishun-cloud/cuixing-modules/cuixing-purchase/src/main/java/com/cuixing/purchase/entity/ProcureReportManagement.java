...
/**
 * 采购报表分析(ProcureReportManagement)表服务类
 *
 * @author 阿江
 * @since 2025-03-19 13:42:31
 */
public class ProcureReportManagement implements Serializable {
    private static final long serialVersionUID = -13420482073073022L;
    /**
     * 采购报表id
     */
    private Long id;
