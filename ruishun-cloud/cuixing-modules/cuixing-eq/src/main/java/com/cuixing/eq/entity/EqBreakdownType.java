 ...
 * @date : 2024-7-3
 */
@ApiModel(value = "设备故障类型")
public class EqBreakdownType extends BaseEntity{
    /** 自增主键 */
    @ApiModelProperty(name = "自增主键")
    private BigInteger id ;
    /** 故障名称 */
    @ApiModelProperty(name = "故障名称" )
    private String breakdownName ;
    /** 所属设备类型id */
    @ApiModelProperty(name = "所属设备类型id")
    private String typeId ;
    /** 所属类型名称 */
    @ApiModelProperty(name = "所属类型名称")
