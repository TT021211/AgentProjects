 ...
 * @date : 2024-6-18
 */
@ApiModel(value = "项目类型设置")
public class EqItemType extends BaseEntity{
    /** 自增主键 */
    ...
    private String attr3 ;
     ...
     /** 类型 */
     @ApiModelProperty(name = "类型(0：点检 1：保养)")
     private String type ;
