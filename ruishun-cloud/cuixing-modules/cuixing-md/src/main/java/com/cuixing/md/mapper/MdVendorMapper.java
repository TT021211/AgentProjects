...
public interface MdVendorMapper{
     ...
     * 批量新增数据
     *
     * @param entities List<MdVendor> 实例对象列表
     * @return 影响行数
     */
    // int insertBatch(@Param("entities") List<MdVendor> entities);
    /**
     * 批量新增或按主键更新数据
     *
     * @param entities List<MdVendor> 实例对象列表
     * @return 影响行数
     */
    int insertOrUpdateBatch(@Param("entities") List<MdVendor> entities);
    /**
     * 更新数据
     *
     * @param mdVendor 实例对象
