...
public class MesProductWorkorder extends BaseEntity{
    ...
    private Double enamellingSchedulingWeight ;
     /** 已排产漆包重量 */
     @ApiModelProperty(name = "已排产退火重量",notes = "")
    private Double annealingSchedulingWeight ;
     /** 已排产漆包重量 */
     @ApiModelProperty(name = "已排产并丝重量",notes = "")
    private Double doublewireSchedulingWeight ;
     /** 已排产漆包重量 */
     @ApiModelProperty(name = "已排产绞线重量",notes = "")
    private Double strandedwireSchedulingWeight ;
     /** 已排产漆包重量 */
     @ApiModelProperty(name = "已排产镀锡重量",notes = "")
    private Double tinningSchedulingWeight ;
    ...
    public void setWeight(Double weight){
     ...
     public Double getAnnealingSchedulingWeight() {
         return annealingSchedulingWeight;
     }

     public void setAnnealingSchedulingWeight(Double annealingSchedulingWeight) {
         this.annealingSchedulingWeight = annealingSchedulingWeight;
     }

     public Double getDoublewireSchedulingWeight() {
         return doublewireSchedulingWeight;
     }

     public void setDoublewireSchedulingWeight(Double doublewireSchedulingWeight) {
         this.doublewireSchedulingWeight = doublewireSchedulingWeight;
     }

     public Double getStrandedwireSchedulingWeight() {
         return strandedwireSchedulingWeight;
     }

     public void setStrandedwireSchedulingWeight(Double strandedwireSchedulingWeight) {
         this.strandedwireSchedulingWeight = strandedwireSchedulingWeight;
     }

     public Double getTinningSchedulingWeight() {
         return tinningSchedulingWeight;
     }

     public void setTinningSchedulingWeight(Double tinningSchedulingWeight) {
         this.tinningSchedulingWeight = tinningSchedulingWeight;
     }
