...
public class DoublewireWorkorderVo {
    /** 自增主键 */
    ...
    public String getDoublewireCode() {
        return doublewireCode;
    }

    public void setDoublewireCode(String doublewireCode) {
        this.doublewireCode = doublewireCode;
    }
