...
public class MesOuputLog extends BaseEntity {
    ...
    /** 线盘id*/
    @ApiModelProperty("线盘id")
    @Excel(name = "线盘id")
    private BigInteger wireDiscId;

    /** 线盘id*/
    @ApiModelProperty("交班人id")
    @Excel(name = "交班人id")
    private BigInteger shiftScheduleId;

    /** 线盘id*/
    @ApiModelProperty("交班人名称")
    @Excel(name = "交班人名称")
    private String shiftScheduleName;

    /** 报工皮重*/
    @ApiModelProperty("交班人报工重量")
    @Excel(name = "交班人报工重量")
    private BigDecimal shiftScheduleWeight;
    ...
    public BigInteger getShiftScheduleId() {
        return shiftScheduleId;
    }

    public void setShiftScheduleId(BigInteger shiftScheduleId) {
        this.shiftScheduleId = shiftScheduleId;
    }

    public BigDecimal getShiftScheduleWeight() {
        return shiftScheduleWeight;
    }

    public void setShiftScheduleWeight(BigDecimal shiftScheduleWeight) {
        this.shiftScheduleWeight = shiftScheduleWeight;
    }
}
