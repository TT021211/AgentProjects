...
public class TinningWorkorderVo {
    /** 自增主键 */
    ...
    public String getTinningCode() {
        return tinningCode;
    }

    public void setTinningCode(String tinningCode) {
        this.tinningCode = tinningCode;
    }
