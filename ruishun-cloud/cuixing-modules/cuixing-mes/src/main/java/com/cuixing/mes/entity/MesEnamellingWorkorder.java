 ...
 * @date : 2024-6-11
 */
@ApiModel(value = "漆包工单",description = "")
public class MesEnamellingWorkorder extends BaseEntity{
    /** 自增主键 */
    ...
    /** 轴号 */
    @ApiModelProperty(name = "轴号",notes = "")
    private String axleNumber ;
    /** 线盘 */
    @ApiModelProperty(name = "线盘",notes = "")
    private String wireDisc ;
    /** 油漆 */
    @ApiModelProperty(name = "油漆",notes = "")
    ...
    /** 状态(0:未排除 1:已排产 2:已完成 3:已作废) */
    @ApiModelProperty(name = "状态(0:未排除 1:已排产 2:已完成 3:已作废)",notes = "")
    ...
    private String attr3 ;
     ...
     /** 漆包工单号 */
     @ApiModelProperty(name = "漆包工单号",notes = "")
     private String enamellingCode ;
      ...
      * 插单id
      */
     @ApiModelProperty(name = "插单id",notes = "")
     private BigInteger insertId ;
     /**
      * 插单状态
      */
     @ApiModelProperty(name = "插单状态",notes = "")
     private String insertStatus ;
     /**
      * 插单工单号
      */
     @ApiModelProperty(name = "插单工单号",notes = "")
     private String insertWorkorder ;
     /**
      * 插单型号
      */
     @ApiModelProperty(name = "插单型号",notes = "")
     private String insertModel ;

     /**
      * 油漆数量
      */
     @ApiModelProperty(name = "油漆数量",notes = "")
     private Integer plantNumber ;

     /**
      * 线盘数量
      */
     @ApiModelProperty(name = "线盘数量",notes = "")
    ...
    public void setWorkorderId(BigInteger workorderId) {this.workorderId = workorderId;}
     ...
     public String getEnamellingCode() {
         return enamellingCode;
     }

     public void setEnamellingCode(String enamellingCode) {
         this.enamellingCode = enamellingCode;
     }
