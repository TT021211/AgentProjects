...
public class StrandedwireWorkorderVo {
    /** 自增主键 */
     ...
     * 绞线工单号
     */
    private String strandedwireCode;
    ...
    private String AlexPositionNumbers ;

    private List<InputArrayVo> inputIds ;
    ...
    public String getStrandedwireCode() {
        return strandedwireCode;
    }

    public void setStrandedwireCode(String strandedwireCode) {
        this.strandedwireCode = strandedwireCode;
    }
    ...
    public String getAlexPositionNumbers() {
        return AlexPositionNumbers;
    }

    public void setAlexPositionNumbers(String alexPositionNumbers) {
        AlexPositionNumbers = alexPositionNumbers;
    }

    public List<InputArrayVo> getInputIds() {
        return inputIds;
    }

    public void setInputIds(List<InputArrayVo> inputIds) {
