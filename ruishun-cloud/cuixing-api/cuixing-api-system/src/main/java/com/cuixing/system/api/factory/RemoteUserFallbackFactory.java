...
public class RemoteUserFallbackFactory implements FallbackFactory<RemoteUserService> {
	...
	public RemoteUserService create(Throwable throwable) {
		...
		return new RemoteUserService() {
			...
			@Override
			public R<LoginUser> getInfoByEnterpriseWechatId(String wechatUserId, String source) {
				return R.fail("获取用户失败:" + throwable.getMessage());
			}

			@Override
			public R<List<SysUser>> getUserByIds(Long[] userIds) {
				return R.fail("获取用户失败:" + throwable.getMessage());
			}

			@Override
			public List<SysUser> getUserToDeviceId(String deviceIds, String source) {
				return null;
			}
