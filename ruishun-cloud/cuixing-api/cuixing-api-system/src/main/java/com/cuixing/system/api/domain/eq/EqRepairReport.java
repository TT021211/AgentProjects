package com.cuixing.system.api.domain.eq;
...
public class EqRepairReport extends BaseEntity{
   ...
   public String toString() {
       return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE)
           ...
           .append("breakdownId", getBreakdownId())
           .append("breakdownName", getBreakdownName())
           .append("breakdownDescription", getBreakdownDescription())
           .append("breakdownImage", getBreakdownImage())
           ...
           .append("isKnowledge", getIsKnowledge())
