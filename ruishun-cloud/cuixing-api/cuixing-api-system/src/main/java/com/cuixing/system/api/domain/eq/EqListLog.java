...
* @date : 2024-7-9
*/
@ApiModel(value = "点检(保养)记录")
public class EqListLog extends BaseEntity{
   /** 自增主键 */
   ...
   /** 状态(0：已完成 1：未点检 2：未保养) */
   @ApiModelProperty(name = "状态(0：已完成 1：未点检 2：未保养)")
   private String status ;
   /** 记录生成时间 */
   @ApiModelProperty(name = "记录生成时间")
