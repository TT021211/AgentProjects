...
/**
 * 模具出库表(MoldOutbound)实体类
 *
 * @author makejava
 * @since 2024-06-28 10:44:01
 */
public class MoldOutbound implements Serializable {
    private static final long serialVersionUID = -79300337097887199L;
    /**
     * 出库id
     */
    private Long moldOutboundId;
    /**
     * 套模id
     */
    ...
    public Long getMoldOutboundId() {
        return moldOutboundId;
    }

    public void setMoldOutboundId(Long moldOutboundId) {
        this.moldOutboundId = moldOutboundId;
    }
    ...
    public Date getMoldOutboundTime() {
        return moldOutboundTime;
    }

    public void setMoldOutboundTime(Date moldOutboundTime) {
        this.moldOutboundTime = moldOutboundTime;
    }
