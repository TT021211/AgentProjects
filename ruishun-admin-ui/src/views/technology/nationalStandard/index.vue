...
import { getNationalStandard, uploadNationalStandard } from '@/service/api/technology/technologyStandard';
...
function exportList() {
  ...
  download('mes/mesProcessStandard/export', null, `国家标准.xlsx`, undefined)
    .then(() => {
...
function submitUpload() {
  ...
  uploadNationalStandard(uploadFormData.value, {
    headers: {
