<template>
  <div>
    <my-card title="搜索条件" search>
      <n-form inline>
        <n-form-item label="作业指导书名称">
          <n-input v-model:value="searchForm.operationName" type="text" placeholder="请输入作业指导书名称" />
        </n-form-item>
        <n-form-item label="作业指导书编码">
          <n-input v-model:value="searchForm.operationCode" type="text" placeholder="请输入作业指导书编码" />
        </n-form-item>
        <n-form-item>
        ...
        <div>
          ...
          >
            <n-grid :cols="2" :x-gap="20">
              <n-form-item-grid-item label="作业指导书名称" path="operationName">
                <n-input
              ...
              <n-form-item-grid-item label="作业指导书编码" path="operationCode">
                <n-input
                  v-model:value="addForm.operationCode"
                  placeholder="请输入作业指导书编码"
                  :style="{ width: formItemWidth }"
                />
              </n-form-item-grid-item>
