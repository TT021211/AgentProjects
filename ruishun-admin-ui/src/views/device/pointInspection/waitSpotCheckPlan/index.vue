<template>
  <div>
    ...
    <my-dialog title="设备点检" :show="dialogFlag" height="200px" @cancel="handleCancel" @submit="handleSubmit">
      <template #content>
        <div>
...
import { PintOutline } from '@vicons/ionicons5';
    ...
    render: row => {
      return [
        <n-button color="#8a2be2" size="tiny" class="mr" onClick={() => handleInfo(row)}>
          <PintOutline class="mr-1px text-15px w-13px" />
          点检
        </n-button>
      ];
    }
